...
const AssociationType = {
 ...
 class Associations {
  ...
  /**
   * @summary create a new association between two Hubspot entities
   */
  ...
  /**
   * @summary create multiple associations between two Hubspot entities
   */
  createBatch(items) {
    ...
    return this.client._request({
      ...
      body: items.map(i => ({
        fromObjectId: i.fromId,
        toObjectId: i.toId,
        category: "HUBSPOT_DEFINED",
        definitionId: i.associationType
      }))
    })
  }
}
